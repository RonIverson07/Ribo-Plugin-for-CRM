...
class RIBO_Elementor_Loader
{
    public static function init()
    {
        ...
        // Enqueue editor script in the main window to handle control metadata sync
        add_action('elementor/editor/after_enqueue_scripts', [__CLASS__, 'enqueue_editor_scripts']);
    }

    /**
     * Enqueue editor-side sync logic in the main frame.
     */
    public static function enqueue_editor_scripts()
    {
        wp_enqueue_script(
            'ribo-el-editor-js',
            RIBO_WP_INBOUND_URL . 'public/assets/elementor-editor.js',
        ['jquery'],
            RIBO_WP_INBOUND_VERSION,
            true
        );

        wp_localize_script('ribo-el-editor-js', 'RIBO_EL_EDITOR', [
